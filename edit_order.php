                                    ...
                                    <div class="card ">
                                        ...
                                        <div class="alert alert-info  font-weight-normal  alert-dismissible fade show"
                                            role="alert"> <button type="button" class="close" data-dismiss="alert"
                                                aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button> <strong> <i class=" mdi mdi-arrow-down-box"></i> </strong>Fill in
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-10 m-auto pb-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            class=" select2  form-control form-control-lg form-control form-control-lg-lg"
                                                            name="customers" id="customers"
                                                            onchange="load_selected_customer_data(this.value)">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg"
                                                            ...
                                                            value="<?php echo $customer_names; ?>" autocomplete="off" />
                                        ...
                                        <div class="card-body bg-light">
                                            ...
                                            <div class="alert alert-dark bg-dark  font-weight-normal  text-white alert-dismissible fade show"
                                                role="alert"> <button type="button" class="close" data-dismiss="alert"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button> <strong> <i class=" mdi mdi-arrow-down-box"></i> </strong> In
                                                this
                                                section, Select the Product from the dropdown and add the product to the
                                                cart
                                                form.
                                            </div>
                                            ...
                                            <div class="card ">
                                                ...
                                                <div class="bg-dark">
                                                    ...
                                                    <h4 class="text-center text-white"> <i
                                                            class="mdi mdi-credit-card-settings"></i> Payment Section
                                                    </h4>
                                                </div>
                                                <br>
                                                <div class="alert alert-info  font-weight-normal   alert-dismissible fade show"
                                                    role="alert"> <button type="button" class="close"
                                                        ...
                                                        <span aria-hidden="true">&times;</span>
                                                    </button> <strong> <i class=" mdi mdi-arrow-down-box"></i> </strong>
                                                    In this
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                <label for="subTotal"
                                                                    class="col-sm-12 control-label">Sub
                                                                    Amount</label>
                                                                <div class="col-sm-12">
                                                                    <div class="input-group">
                                                                        <div class="input-group-prepend">
                                                                            <span
                                                                                class="input-group-text bg-dark text-white">UGX</span>
                                                                        </div>
                                                                        <input type="text"
                                                                            class="form-control form-control-lg"
                                                                            required id="subTotal" name="subTotal"
                                                                            disabled="true"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="paymentStatus"
                                                                    class="col-sm-12 control-label">Payment
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="empty" name="paymentStatus" value="1" <?php if($payment_status == 1) {
                                                                        echo "checked";
                                                                    } ?>>
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="installment" value="2"
                                                                            name="paymentStatus" <?php if($payment_status == 2) {
                                                                        echo "checked";
                                                                    } ?>>
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="full" value="3" name="paymentStatus" <?php if($payment_status == 3) {
                                                                        echo "checked";
                                                                    } ?>>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="grandTotal"
                                                                    class="col-sm-12 control-label">Grand
                                                                    Total</label>
                                                                <div class="col-sm-12">
                                                                    <div class="input-group">
                                                                        <div class="input-group-prepend">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                <label for="paid" class="col-sm-12 control-label">Paid
                                                                    Amount</label>
                                                                <div class="col-sm-12">
                                                                    <div class="input-group">
                                                                        <div class="input-group-prepend">
                                                            ...
                                                            <!--/form-group-->
                                                            <div class="form-group row">
                                                                <label for="due" class="col-sm-12 control-label">Due
                                                                    Amount</label>
                                                                <div class="col-sm-12">
                                                                    <div class="input-group">
                                                                        <div class="input-group-prepend">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="airtel" name="paymentType" value="1" <?php if($payment_type == 1) {
                                                                        echo "checked";
                                                                    } ?>>
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="mtn" value="2" <?php if($payment_type == 2) {
                                                                        echo "checked";
                                                                    } ?> name="paymentType">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="cente" value="3" <?php if($payment_type == 3) {
                                                                        echo "checked";
                                                                    } ?> name="paymentType">
                                                                        <label class="form-check-label" for="cente">
                                                                            <img src="assets/images/cente.png" alt=""
                                                                                width="100"></label>
                                                                    </div>
