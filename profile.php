                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <div id="content">
                                <div class="container-fluid">
                                    <div class="card shadow-md rounded p-4">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <ul class="nav nav-tabs flex-column" id="myTab" role="tablist">
                                                    <li class="nav-item"> <a class="nav-link active" id="first-tab"
                                                            data-toggle="tab" href="#firstTab" role="tab"
                                                            aria-controls="firstTab" aria-selected="true">Personal
                                                            Information</a> </li>
                                                    <li class="nav-item"> <a class="nav-link" id="second-tab"
                                                            data-toggle="tab" href="#secondTab" role="tab"
                                                            aria-controls="secondTab" aria-selected="false">Change
                                                            Password</a> </li>
                                                    <li class="nav-item"> <a class="nav-link" id="third-tab"
                                                            data-toggle="tab" href="#thirdTab" role="tab"
                                                            aria-controls="thirdTab"
                                                            aria-selected="false">Favourites</a> </li>
                                                    <li class="nav-item"> <a class="nav-link" id="fourth-tab"
                                                            data-toggle="tab" href="#fourthTab" role="tab"
                                                            aria-controls="fourthTab" aria-selected="false">Cards</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-md-9">
                                                <div class="tab-content my-3" id="myTabContentVertical">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <form id="personalInformation" method="post">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="custom-select" id="inputCountry"
                                                                            ...
                                                                            <option value="252">Ascension Island
                                                                                (British)</option>
                                                                            ...
                                                                            <option value="245">Bonaire, Sint Eustatius
                                                                                and Saba</option>
                                                                            ...
                                                                            <option value="237">Democratic Republic of
                                                                                Congo</option>
                                                                            ...
                                                                            <option value="77">French Southern
                                                                                Territories</option>
                                                                            ...
                                                                            <option value="94">Heard and Mc Donald
                                                                                Islands</option>
                                                                            ...
                                                                            <option value="101">Iran (Islamic Republic
                                                                                of)</option>
                                                                            ...
                                                                            <option value="139">Micronesia, Federated
                                                                                States of</option>
                                                                            ...
                                                                            <option value="194">South Georgia &amp;
                                                                            ...
                                                                            <option value="208">Tanzania, United
                                                                                Republic of</option>
                                                                            ...
                                                                            <option value="224">United States Minor
                                                                                Outlying Islands</option>
                                                                            <option value="225">Uruguay</option>
                                                                            <option value="226">Uzbekistan</option>
                                                                            <option value="227">Vanuatu</option>
                                                                            <option value="228">Vatican City State (Holy
                                                                                See)</option>
                                                                            ...
                                                                            <option value="233">Wallis and Futuna
                                                                                Islands</option>
                                                            ...
                                                            <div class="col-lg-4 mt-4 mt-lg-0 ">
                                                                <div class="card bg-light-3 p-3">
                                                                    ...
                                                                    <p class="text-1 mb-0">We will not sell or
                                                                        distribute your contact information. Read our <a
                                                                            href="#">Privacy Policy</a>.</p>
                                                                    <hr>
                                                                    <p class="mb-2">Billing Enquiries</p>
                                                                    <p class="text-1 mb-0">Do not hesitate to reach our
                                                                        <a href="#">support team</a> if you have any
                                                                        queries.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="secondTab" role="tabpanel"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-8">
                                                                ...
                                                                <form id="changePassword" method="post">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control"
                                                                            data-bv-field="newpassword" id="newPassword"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="text-center align-middle"><img
                                                                                class="border p-1 rounded bg-light"
                                                                                src="images/brands/operator/vodafone.jpg"
                                                                                alt=""></td>
                                                                        <td class="text-center align-middle">9898989898
                                                                        </td>
                                                                        <td class="text-center align-middle">Vodafone
                                                                        </td>
                                                                        <td class="align-middle">
                                                                            <div class="d-flex justify-content-end">
                                                                                <button
                                                                                    class="btn btn-sm btn-outline-primary shadow-none text-nowrap"
                                                                                    type="submit">Recharge Now</button>
                                                                                <button
                                                                                    class="btn btn-sm btn-outline-secondary shadow-none ml-1"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center align-middle">9696969696
                                                                        </td>
                                                                        <td class="text-center align-middle">Vodafone
                                                                        </td>
                                                                        <td class="align-middle">
                                                    ...
                                                    <div class="tab-pane fade" id="fourthTab" role="tabpanel"
                                                        aria-labelledby="fourth-tab">
                                                        <div class="row">
                                                            <div class="col-lg-5">
                                                                <h4 class="mb-4">Your Saved Cards</h4>
                                                                <div id="savedCard"
                                                                    class="bg-light-4 rounded p-3 mb-4 mb-lg-0">
                                                                    ...
                                                                    <p class="d-flex m-0">
                                                                        ...
                                                                        <a href="#"><i class="fas fa-minus-circle"></i>
                                                                            Remove</a>
                                                                        <img class="ml-auto"
                                                            ...
                                                            <div class="col-lg-7">
                                                                ...
                                                                <form id="payment" method="post">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control"
                                                                            data-bv-field="cardnumber" id="cardNumber"
