                                                    ...
                                                    <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg"
                                                                    name="price[]" id="price<?php echo $x; ?>">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        id="subTotal" name="subTotal" disabled="true" />
                                                                </div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        id="grandTotal" required name="grandTotal"
                                                                        disabled="true" />
                                                                </div>
                                                                <input type="hidden"
                                                                    class="form-control form-control-lg"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-lg" id="paid"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-lg" id="due"
                                                                        name="due" disabled="true" />
                                                                </div>
                                                                <input type="hidden"
                                                                    class="form-control form-control-lg" id="dueValue"
                                                                    name="dueValue" />
                                                            </div>
                                                        </div>
                                                        <!--/form-group-->
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio"
                                                                        id="cente" value="3" name="paymentType">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class=" btn-group btn-group-lg float-right">
                                                        ...
                                                        <button type="submit" id="createOrderBtn"
                                                            class="btn btn-success"><i class="fas fa-paper-plane"></i>
                                                            Save
                                                            Changes</button>
